...
class KVCacheMonitor:
    ...
    def get_vram_usage(self) -> Dict[str, float]:
        ...
        logging.warning("[KV-Monitor] CUDA is unavailable. VRAM monitoring is disabled.")
    ...
    def log_iteration_end(self, iteration: int, generation_time_ms: float, prompt_length_tokens: int, n_selected_chunks: int, n_archived_chunks_this_iter: int) -> Dict:
        ...
        if start_entry:
            ...
            logging.warning(f"[KV-Monitor] Start entry for iteration {iteration} not found for end logging.")
            end_metrics_entry = {
                'iteration': iteration,
                'event': 'end_no_start',
                'generation_time_ms': generation_time_ms,
    ...
    def get_summary_stats(self) -> Dict[str, float]:
        """
        Gets summary statistics for the all process time.
        """
