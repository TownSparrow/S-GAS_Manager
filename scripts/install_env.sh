...
echo ""
echo "1)  Creation the virtual environment..."
...
echo "3) Upgrade of pip, setuptools and wheel..."
...
echo ""
echo "📝 Next steps:"
echo "   1. Activate environment: source S-GAS_Manager_env/bin/activate"
echo "   2. Set the params in configs/system_params.json"
