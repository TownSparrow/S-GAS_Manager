    ...
    el.innerHTML = scenarios.map(s => `
        <div class="scenario-card">
            ...
            <div class="button-group">
                <button onclick="runBenchmark('${s}')">Run Benchmark</button>
            </div>
        </div>
    `).join('');
}
    ...
    el.innerHTML = `
        ...
        <table class="comparison-table">
            ...
            <tbody>
                ...
                ${renderRow('Text Precision@K (key-phrase)', quality.precision, true)}
                ${renderRow('Recall@K (chunk-ID)', quality.recall_at_k, true)}
        ...
        <table class="comparison-table">
            ...
            <tbody>
                ...
                ${renderRow('Peak VRAM (GB)', perf.peak_vram_gb)}
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
            <div class="summary-card">
                ...
                <p>Avg Latency: ${sgasSummary.avg_latency_ms?.toFixed(0) || 0}ms | Peak VRAM: ${sgasSummary.peak_vram_gb || 0} GB</p>
                <p>Coverage: ${((sgasSummary.final_coverage || 0) * 100).toFixed(1)}%</p>
            </div>
            <div class="summary-card">
                <h4>Baseline</h4>
                <p>Turns: ${baseSummary.total_turns || 0} | Duration: ${baseSummary.session_duration_s || 0}s</p>
                <p>Avg Latency: ${baseSummary.avg_latency_ms?.toFixed(0) || 0}ms | Peak VRAM: ${baseSummary.peak_vram_gb || 0} GB</p>
